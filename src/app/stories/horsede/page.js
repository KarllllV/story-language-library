...
import { dictionary } from "@/data/dictionarydehorse";
...
export default function HorseStoryDePage() {
  ...
  function handleWordClick(originalWord) {
    ...
    setSelectedWord({
      word: cleanWord,
      translation:
        wordInformation?.translation ||
        "Die Übersetzung ist noch nicht im Wörterbuch.",
      example:
        wordInformation?.example ||
        "Ein Beispielsatz ist noch nicht verfügbar.",
        ...
        >
          ...
          <div style={{ padding: "28px" }}>
            ...
            >
              ...
              >
                Rychlost hlasu: {readingSpeed.toFixed(2)}×
              </label>
            ...
            >
              ...
              <button
                type="button"
                disabled={currentPageIndex === horseStoryDe.pages.length - 1}
                onClick={() => changePage(currentPageIndex + 1)}
                style={{
                  padding: "12px 18px",
                  border: "none",
