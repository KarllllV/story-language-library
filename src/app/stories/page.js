    ...
    versions: [
      {
        ...
        level: "A1–A2",
        description:
          "Jantar must overcome his fear and cross dangerous mountains to bring help and save Podlesi from a flood.",
        href: "/stories/horse",
        price: "Zdarma",
        available: true,
        free: true,
      ...
      },
      {
        ...
        level: "A1–A2",
        description:
          "Jantar muss seine Angst überwinden und durch gefährliche Berge reisen, um Hilfe zu holen und Podlesi vor einer Überschwemmung zu retten.",
      ...
      },
      {
        ...
        level: "A1–A2",
        description:
          "Jantar musí překonat svůj strach a vydat se přes nebezpečné hory pro pomoc, aby zachránil Podlesí před povodní.",
    ...
    versions: [
      {
        ...
        level: "A1–A2",
        description:
          "Ryska investigates why water is disappearing from the Silver Spring and uses her cleverness, courage and friendship to help save the forest.",
        href: "/stories/fox",
        price: "Zdarma",
        available: true,
        free: true,
      ...
      },
      {
        ...
        level: "A1–A2",
        description:
          "Ryska untersucht, warum das Wasser aus der Silberquelle verschwindet, und hilft mit Klugheit, Mut und Freundschaft, den Wald zu retten.",
        href: "/stories/foxde",
        price: "Zdarma",
        available: true,
        free: true,
      ...
      },
      {
        ...
        level: "A1–A2",
        description:
          "Ryška pátrá po příčině mizející vody ze Stříbrného pramene a díky důvtipu, odvaze a přátelství pomůže zachránit les.",
        href: "/stories/foxcz",
        price: "Бесплатно",
        available: true,
        free: true,
...
const localizedStories = {
  ...
  horse: {
    ...
    descriptionRu:
      "Молодой конь Янтар должен преодолеть свой страх и отправиться через опасные горы за помощью, чтобы спасти Подлеси от наводнения.",
  },
  fox: {
    titleCs: "Chytrá liška a tajemství Stříbrného pramene",
    titleRu: "Умная лиса и тайна Серебряного источника",
    pagesCs: "30 stran",
    pagesRu: "30 страниц",
    descriptionCs:
      "Liška Ryška pátrá po příčině mizející vody ze Stříbrného pramene a díky důvtipu, odvaze a přátelství pomůže zachránit celý les.",
    descriptionRu:
      "Умная лиса Рыжка расследует исчезновение воды из Серебряного источника и благодаря находчивости, смелости и дружбе помогает спасти весь лес.",
  },
  bear: {
